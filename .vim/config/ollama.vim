...
let g:ollama_model = 'qwen2.5-coder:latest'
...
" chat model
let g:ollama_chat_model = 'qwen2.5-coder:latest'
" override chat system prompt
"let g:ollama_chat_systemprompt = 'Give funny answers.'

" edit model
let g:ollama_edit_model = 'qwen2.5-coder:latest'
...
" Accept the current suggestion with Ctrl-g
inoremap <silent> <C-g> <Plug>(ollama-tab-completion)

" Dismiss the suggestion with Ctrl-] (if you want)
inoremap <silent> <C-]> <Plug>(ollama-dismiss)
